<template>
  <PageDivisionLayout>
    ...
    <template #divisionContent>
      <div v-if="!isLoading">
        <div
          class="flex flex-col m-24 px-12 items-center text-secondary bg-pop-secondary/80 rounded-md"
        >
          <div
            class="w-36 h-36 -mt-20 border-8 rounded-full overflow-hidden border-pop-primary"
          >
            <img
              v-if="user.picture"
              :src="user.picture"
